...
public class DataTable {
	...
	public void setRow(int row, Integer[] values) {
		if (values.length != this.columns) {
			throw new IllegalArgumentException("values array size ("
					+ values.length + ") must match DataTable nColumns ("
					+ this.columns + ").");
		}
