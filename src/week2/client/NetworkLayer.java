 ...
 * @version 03-01-2015
 *
 *          Provides an unreliable packet transmission framework to the reliable
...
public class NetworkLayer {
	 ...
	 * 
	 * @param client
	 *            The challenge client to be used as transmission medium
	 */
	 ...
	 * 
	 * @return The content of the packet as an array of Integers, or null if no
	 *         packet was received
	 */
